...
router.get("/list", (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const time =
        ((_a = data.detailSort) === null || _a === void 0 ? void 0 : _a.time) ||
        "";
      const view =
        ((_b = data.detailSort) === null || _b === void 0 ? void 0 : _b.view) ||
        "";
      const like =
        ((_c = data.detailSort) === null || _c === void 0 ? void 0 : _c.like) ||
        "";
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const newCommunityComment =
        yield models_1.default.communityComments.create({
          content: comment,
          userId,
          postId,
        });
